...
Before you can login into the server, you need to activate the VPN client. If you are not familiar with the VPN client, please visit [this website](https://rrzk.uni-koeln.de/en/internet-access-web/network-access/vpn).
