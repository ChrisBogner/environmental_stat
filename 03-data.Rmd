...
We will talk much more about data visualisation later. For now, just use the code below to visualize the relationship between the flipper length and the body mass of the animals.
...
1. What is the time span of the measurments?

1. Find the levels of the variable `island`.

1. This is a challenge `r emo::ji('smile')`. Take the code that produced the visualisation of flipper length and the body mass of the animals. Make an educated guess how to change the code such that it produces the visualisation of the bill length vs. body mass. Can you also guess how to adjust the label on the x axis?
...
## Additional reading
In case you prefer flights to penguins, you have a look at data exploration in Chapter 1.4 in @ModernDive
