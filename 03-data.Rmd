...
1. This is a challenge `r emo::ji('smile')`. Take the code that produced the visualisation of flipper length and the body mass of the animals. Make an educated guess how to change the code such that it produces the visualisation of the bill depth vs. body mass. Can you also guess how to adjust the label on the x axis?
